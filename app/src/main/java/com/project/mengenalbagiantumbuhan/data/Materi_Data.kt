...
object Materi_Data {
    private val iconName = intArrayOf(
        R.drawable.icon_akar,
        R.drawable.icon_batang,
        R.drawable.icon_daun,
    ...
    private val isimenuPertama = arrayOf(
        "Secara umum akar terdiri atas akar utama, cabang akar, dan rambut akar. Akar utama adalah bagian akar yang cukup besar, berbentuk mengerucut dan tumbuh lurus menembus tanah. Pada akar utama, tumbuh cabang akar dan rambut akar.",
        "Batang tanaman berkayu, memilih bagian yang disebut pembuluh tapis yang bertugas mengangkut makanan hasil fotosistesis dari daun ke semua bagian tumbuhan. Di bagian dalam pembuluh tapis, pada tanaman di atas terdapat lapisan kambium. \n" +
                "\n" + "Di bagian dalam lapisan kambium, terdapat pembuluh kayu yang berguna untuk mengangkut air dan mineral yang diserap oleh akar menuju daun. Batang yang berkambium pada umumnya akan membentuk lingkaran tahun, seperti pada gambar di bawah ini:",
        "Pada tanaman yang memiliki daun lengkap, daun terdiri dari pelepah daun, tangkai daun, dan helai daun. \n" +
                "\n" + "Contoh daun yang merupakan daun lengkap adalah daun pisang. Terdapat pula tanaman yang memiliki daun tidak lengkap, yaitu hanya memiliki tangkai daun dan helai daun saja. Contoh daun yang merupakan daun tidak lengkap adalah daun jeruk.",
        "Buah terdiri dari kulit buah, daging buah, dan biji.",
        "Bagian-bagian pada bunga terdiri dari tangkai, kelopak, mahkota, benang sari (organ reproduksi jantan), dan putik (organ reproduksi wanita).",
        "Fungsi dari biji di antaranya:\n" +
    ...
    private val gambarmenuPertama = intArrayOf(
        R.drawable.menu1_akar,
        R.drawable.menu1_batang,
    ...
    private val isimenuKedua = arrayOf(
    ...
    private val gambarmenuKedua = intArrayOf(
        R.drawable.menu2_akar,
        0,
        R.drawable.menu2_daun,
        0,
        0,
        0,
        0,
    ...
    private val submenuKetiga = arrayOf(
        "c. Fungsi Akar",
        "c. Fungsi Batang",
        "c. Fungsi Daun",
        "0",
    ...
    private val isimenuKetiga = arrayOf(
        "Akar merupakan bagian tumbuhan yang sangat penting. Keberadaan akar pada tumbuhan sangat menentukan kelangsungan hidup tumbuhan. Fungsi akar bagi tumbuhan antara lain:\n" +
                ...
                "3)\tTempat menyimpan cadangan makanan (untuk beberapa jenis tanaman tertentu, misalnya singkong)\n",
        "Fungsi batang bagi tumbuhan, antara lain seperti berikut:\n" +
                ...
                "Sebagai tempat menyimpan cadangan makanan (untuk beberapa jenis tanaman tertentu, misalnya tebu)\n",
        "Fungsi utama daun pada tumbuhan adalah sebagai tempat membuat makanan atau tempat terjadinya proses fotosintesis, seperti pada gambar di bawah ini. Selain itu, daun juga berguna sebagai tempat penguapan air dan sebagai alat pernapasan pada tumbuhan,",
        "0",
        "0",
        "0",
        "0",
    ...
    private val gambarmenuKetiga = intArrayOf(
    ...
    val listdata: ArrayList<Materi>
        get() {
            ...
            for(position in TextName.indices){
                val materi = Materi()
                materi.name = TextName[position]
                materi.icon = iconName[position]
                materi.paragrafPertama = paragrafPertama[position]
                materi.submenuPertama = submenuPertama[position]
                materi.isimenuPertama = isimenuPertama[position]
                materi.gambarmenuPertama = gambarmenuPertama[position]
                materi.submenuKedua = submenuKedua[position]
                materi.isimenuKedua = isimenuKedua[position]
                materi.gambarmenuKedua = gambarmenuKedua[position]
                materi.submenuKetiga = submenuKetiga[position]
                materi.isimenuKetiga = isimenuKetiga[position]
                materi.gambarmenuKetiga = gambarmenuKetiga[position]
                list.add(materi)
            }
            return list
        }
