...
object Materi_Data {
    ...
    private val isimenuKedua = arrayOf(
        ...
        "Berdasarkan kambiumnya, terdapat batang yang berkambium dan batang yang tidak berkambium. Contoh tanaman yang memiliki batang ber-kambium adalah mangga. Sementara itu, contoh tanaman yang batangnyatidak berkambium adalah kelapa. Batang tanaman dapat pula dibedakan berdasarkan bentuknya, yaitu batang berkayu seperti pada jambu, batang basah seperti pada bayam, dan batang rumput seperti pada padi.",
        "Berdasarkan bentuk tulang daunnya, daun dibedakan menjadi daun bertulang daun menyirip, menjari, melengkung, dan sejajar. Contoh daun menyirip adalah daun mangga. Contoh daun menjari adalah daun pepaya. Contoh daun melengkung adalah daun sirih. Contoh daun sejajar adalah daun jagung.",
